  ...
  var mixin = function (view, options) {
    return {
      ...
      validate: function (attrs, setOptions) {
        ...
        var modelAttrs = _.omit(model, _.functions(model), ['_Collection']);
        var allAttrs = _.extend({}, validatedAttrs, modelAttrs, attrs);
        ...
        // _.each(validatedAttrs, function (val, attr) {
        //   var invalid = result.invalidAttrs.hasOwnProperty(attr);
        //   var changed = changedAttrs.hasOwnProperty(attr);
